        ...
        <h4 class="subheading"> 
          ...
          >
            <div>
              ...
              >
                <a
                  href="https://www.terra.money/ecosystem/alliance"
                  target="_blank"
                >More information</a>
              </v-btn>
            </div>
        ...
        >
          <v-card>
            ...
            <v-card-text>
              ...
              Alliance Integration is done on proposal #53 <br><a
                href="https://www.mintscan.io/chihuahua/proposals/53"
                target="_blank"
              >https://www.mintscan.io/chihuahua/proposals/53</a>
            </v-card-text>
          </v-card>
        </v-timeline-item>
